...
class InformedRRTStar:
    ...
    def __init__(self, start, goal, obstacle_list, rand_area, expand_dis=1.0,
                 goal_sample_rate=5, max_iter=200):
...
def main():
    ...
    # Set params
    rrt = InformedRRTStar(start=[0, 0], goal=[6, 10], rand_area=[-2, 15],
